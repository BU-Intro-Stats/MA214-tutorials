...
$$ \widehat{bwt} = \widehat{\beta}_0 + \widehat{\beta}_1 \cdot gestation + \widehat{\beta}_2 \cdot age $$
...
$$
    \widehat{bwt} = \widehat{\beta}_0 + \widehat{\beta}_1 \cdot gestation + \widehat{\beta}_2 \cdot age + \widehat{\beta}_3 \cdot smoke
$$
...
\begin{align}
    \widehat{bwt} &= \widehat{\beta}_0 + \widehat{\beta}_1 \cdot gestation + \widehat{\beta}_2 \cdot age + \widehat{\beta}_3 \cdot smoke \\
    &~~~+ \widehat{\beta}_4 \cdot height + \widehat{\beta}_5 \cdot weight + 
    \widehat{\beta}_6 \cdot parity
    \end{align}
$$
