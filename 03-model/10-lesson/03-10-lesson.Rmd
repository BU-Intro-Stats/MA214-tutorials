...
<details>
<summary>**Hint**</summary>
What is the difference between the coefficients that are in both models?
</details>
...
```{r mc2}
question("Identify all statments that are *TRUE*:",
...
", correct = TRUE),
  answer("The change in the coefficient of food from $2.94 in the simple linear model to $2.88 in this model could have practical implications for restaurant owners.", correct = TRUE),
allow_retry=TRUE
)
```
...
<details>
<summary>**Hint**</summary>
Does being on the East side increase or decrease the price of a meal?
</details>
...
<details>
<summary>**Hint**</summary>
If the coefficient on `Service` changes so much, how likely is it that any interpretation relying on the estimate is valid?
</details>
