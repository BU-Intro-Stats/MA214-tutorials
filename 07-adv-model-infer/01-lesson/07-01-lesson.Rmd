...
### Linear model for the demographic data
...
ggplot(data=data, aes(sample=income)) +
  stat_qq() + 
  stat_qq_line() +
...
2. The quantiles in the QQ plot deviate from the diagonal, indicating that the data are not normally distributed.
...
This model is also not perfect, but let's see how the two compare. 
