...
***TODO***
Outline:
- Find dataset 2, load and perform simple lm to get a base model
- Show uncertainty in model with different repeat samples
...
***TODO***
Outline:
- Extract estimates (dataset 2) for them, display head
- Repeat graph
- MC question
