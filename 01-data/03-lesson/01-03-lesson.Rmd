...
For the next two questions, choose the best words to fill in the blanks. 

```{r quiz-experimental-design-terminology}
quiz(
  question("___ variables are conditions you can impose on the experimental units, while ___ variables are characteristics that the experimental units come with that you would like to control for.", correct = "Nice job!", allow_retry = TRUE,
    answer("Blocking, explanatory", message = "Not quite!"),
    answer("Treatment, blocking", correct = TRUE),
    answer("Control, treatment", message = "Nope, try again!"),
    answer("Explantory, control", message = "Try again!")), caption = "")
```


```{r quiz-blocking-and-stratifying}
quiz(
  question("In random sampling, we use ___ to control for a variable. In random assignment, we use ___ to achieve the same goal.", correct = "Correct!", allow_retry = TRUE,
