...
The former interpretation is often attributed to a *Frequentist* way of thinking, while the second is more *Bayesian*. Which one feels more intuitive to you will depend on how you think, and both are valuable ways of approaching statistical problems. You'll notice that the Frequentist philosophy is more explicitly taught in Statistics classes, including in this one (so far!). Starting from now, we will explore the Bayesian way. 


## Big Picture

***TODO: incorporate knowledge-building figures from BR - can just paste and cite?***
