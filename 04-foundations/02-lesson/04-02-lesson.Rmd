...
- Tabulate the small dataset, `gender_discrimination_small`. That is, call `count()`, passing the `gender` and `decision` columns, to get a contingency table.
...
The `gender_discrimination_new_perm` and `diff_orig_new` datasets are also available in your workspace.
