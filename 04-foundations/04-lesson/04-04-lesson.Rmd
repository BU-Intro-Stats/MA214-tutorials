...
<!-- *TODO: check this output - need 0.087 to show* -->
...
*TODO: move to first subsection, before CLT*
...
Then for large $B$, the Central Limit Theorem says that $\widehat{p}^*$ is approximately normally distributed with mean $p$ and standard deviation $\sqrt{\frac{p(1-p)}{B}}$. The following plot shows $B=200$ bootstrap resamples, with the true parameter $p$ in red. The blue dot in the right tail represents one sample value, which would be a poor estimate for $p$.
