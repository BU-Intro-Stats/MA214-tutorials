...
*TODO: add to intro using 213 slides*
*TODO: formally write CLT*

For large samples, $\widehat{p}^*$ is approximately normally distributed with mean $p$ and standard deviation $\sqrt{\frac{p(1-p)}{n}}$. The following plot shows $n=200$ bootstrap resamples, with the true parameter $p$ in red. The blue dot in the right tail represents one sample value, which would be a poor estimate for $p$.

*TODO: ask a concept check question*
