...
The following plot shows $B=200$ bootstrap resamples. The red and blue dots each represent two different point estimates for $p$, only one of which is close to the true value.
...
where the mean is the value of the true parameter. 
